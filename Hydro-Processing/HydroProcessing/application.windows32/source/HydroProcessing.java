...
public class HydroProcessing extends PApplet {
...
public void lectureBuffer() {
  ...
  while (myPort.available () > 0) { 
    ...
    if (PApplet.parseChar(octetReception)=='C') Cont=1;
    ...
    if (octetReception == '*') { 
      ...
      caractereReception = PApplet.parseChar(octetReception); 
...
public void mouseClicked() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "HydroProcessing" };
    if (passedArgs != null) {
